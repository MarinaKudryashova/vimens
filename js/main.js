...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_header_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/header-scroll */ "./src/js/components/header-scroll.js");
...
/* harmony import */ var _components_sideform__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/sideform */ "./src/js/components/sideform.js");
/* harmony import */ var _components_sideform__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_sideform__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_fullscreen__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/fullscreen */ "./src/js/components/fullscreen.js");
/* harmony import */ var _components_about_video__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/about-video */ "./src/js/components/about-video.js");
/* harmony import */ var _components_numbers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/numbers */ "./src/js/components/numbers.js");
/* harmony import */ var _components_numbers__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_components_numbers__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _components_fslightbox_img__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/fslightbox-img */ "./src/js/components/fslightbox-img.js");
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/video */ "./src/js/components/video.js");
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_components_video__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _components_block_scrollbar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/block-scrollbar */ "./src/js/components/block-scrollbar.js");
/* harmony import */ var _components_hotpoint__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/hotpoint */ "./src/js/components/hotpoint.js");
/* harmony import */ var _components_vacanies_accordion__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/vacanies-accordion */ "./src/js/components/vacanies-accordion.js");
/* harmony import */ var _components_scrolltop__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/scrolltop */ "./src/js/components/scrolltop.js");
/* harmony import */ var _components_scrolltop__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_components_scrolltop__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _components_init_yandexmap__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/init-yandexmap */ "./src/js/components/init-yandexmap.js");
/* harmony import */ var _components_init_yandexmap__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_components_init_yandexmap__WEBPACK_IMPORTED_MODULE_16__);
...
/***/ "./src/js/components/about-video.js":
/*!******************************************!*\
  !*** ./src/js/components/about-video.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('DOMContentLoaded', event => {
  ...
  const videoBox = document.querySelector('.videoblock');
  const playBtn = document.querySelector('.videoblock__btn-play');
  if (video) {
...
/***/ "./src/js/components/block-scrollbar.js":
/*!**********************************************!*\
  !*** ./src/js/components/block-scrollbar.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", () => {
  const BLOCK_SROLL = document.querySelectorAll('[data-simplebar]');
  BLOCK_SROLL.forEach(block => {
    new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](block, {
      autoHide: false
    });
  });
});
...
/***/ "./src/js/components/fslightbox-img.js":
/*!*********************************************!*\
  !*** ./src/js/components/fslightbox-img.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", () => {
  const hotpointBtnArr = document.querySelectorAll('.hotpoint__btn');
  if (hotpointBtnArr) {
    if (_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isDesktop) {
      hotpointBtnArr.forEach(btn => {
    ...
    if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isTablet)() || (0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)()) {
      hotpointBtnArr.forEach(btn => {
...
/***/ "./src/js/components/init-yandexmap.js":
/*!*********************************************!*\
  !*** ./src/js/components/init-yandexmap.js ***!
  \*********************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  const mapContainerArr = document?.querySelectorAll('.office__map');
  if (mapContainerArr) {
    mapContainerArr.forEach(mapContainer => {
      let center = `${mapContainer.dataset.center}`.split(',');
      let iconHref = mapContainer.dataset.iconHref;
      let hintMaket = `<div class="contacts__map-hint">${mapContainer.dataset.hint}</div>`;
      function init() {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const dropNavLinks = document?.querySelectorAll('.dropdown-nav__link');
  const productMenuArr = document?.querySelectorAll('.product-menu');
  const closeMenu = () => {
  ...
  const closeProductMenu = () => {
    dropNavLinks.forEach(navlink => {
      navlink?.classList.remove('is-visible');
    });
    productMenuArr.forEach(productMenu => {
      productMenu?.classList.remove('is-visible');
    });
  };
  if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isDesktop)()) {
    menuLinks.forEach(link => {
      link.addEventListener('mouseover', e => {
        ...
        link?.parentNode?.querySelector('.dropdown')?.classList?.add('is-visible');
        closeProductMenu();
        const firstDropNavLink = link?.parentNode?.querySelector('.dropdown')?.querySelector('.dropdown__nav')?.querySelector('.dropdown-nav__item')?.firstElementChild;
        firstDropNavLink?.classList?.add('is-visible');
        const path = firstDropNavLink?.dataset?.path;
        productMenuArr.forEach(productMenu => {
          productMenu?.clasistsL?.remove('is-visible');
          document.querySelector(`[data-target="${path}"]`)?.classList?.add('is-visible');
        });
      });
      link.addEventListener('mouseout', e => {
        if (!link?.parentNode?.querySelector('.dropdown')?.classList?.contains('is-visible')) {
          link.classList?.remove('is-visible');
          link?.parentNode?.querySelector('.dropdown')?.classList?.remove('is-visible');
          closeProductMenu();
        }
      });
    });
    dropNavLinks.forEach(navlink => {
      navlink.addEventListener('mouseover', e => {
        closeProductMenu();
        navlink.classList.add('is-visible');
    ...
    headerTop.addEventListener('mouseover', e => {
      closeMenu();
      closeProductMenu();
    });
  }
  if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isTablet)() || (0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)()) {
    ...
    const menuLinksArr = document?.querySelectorAll('[data-menu-link]');
    const menuBtnsArr = document?.querySelectorAll('[data-submenu]');
    const productMenuBtnsArr = document?.querySelectorAll('[data-product-menu]');
    const subMenuArr = document?.querySelectorAll('.submenu');
    const productMenuArr = document?.querySelectorAll('.product-menu__list');
    const closeMenu = () => {
      menu.classList.remove('is-open');
      burger.classList.remove('is-open');
      burger.setAttribute('aria-expanded', 'false');
      burger.setAttribute('aria-label', 'Открыть меню');
      menuBtnsArr.forEach(btn => {
        btn.classList.remove('is-open');
      });
      subMenuArr.forEach(menu => {
        menu.classList.remove('is-open');
      });
      productMenuBtnsArr.forEach(btn => {
        btn?.classList.remove('is-open');
      });
      productMenuArr.forEach(menu => {
        menu?.classList.remove('is-open');
      });
    };
    ...
    menuBtnsArr.forEach(menBtn => {
      menBtn.addEventListener('click', e => {
        menBtn?.classList.toggle('is-open');
        menBtn?.parentNode.querySelector('.submenu').classList.toggle('is-open');
      });
    });
    productMenuBtnsArr.forEach(productMenuBtn => {
      productMenuBtn.addEventListener('click', e => {
        productMenuBtn?.classList.toggle('is-open');
        productMenuBtn?.parentNode.querySelector('.product-menu__list').classList.toggle('is-open');
      });
    });
...
document.addEventListener('DOMContentLoaded', event => {
  ...
  document.addEventListener('wpcf7mailsent', function (response) {
    ...
    new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]().open('modal-send');
  }, false);
});
...
document.addEventListener("DOMContentLoaded", () => {
  const countArr = document.querySelectorAll('[data-count]');
  const SPEED = 200;
  function numbersStart() {
    countArr.forEach(counter => {
      ...
      const animate = () => {
        tempValue += time;
        if (tempValue < value) {
          counter.innerText = Math.round(tempValue);
  ...
  const numbersObserver = new IntersectionObserver(_ref => {
    let [entry] = _ref;
    const numbersBlock = entry.target || {};
    // Если блок видимо полностью
    if (entry.isIntersecting || entry.intersectionRatio >= 1.0) {
      numbersStart();
      numbersObserver.unobserve(numbersBlock);
    }
  }, {
  ...
  document.querySelectorAll('.numbers').forEach(numbersBlock => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const btnOpen = document.querySelector('.header__search-open');
  const formSearch = document?.querySelector('.search');
  const input = document.querySelector('.search__input');
  let openSearchbar = function () {
    formSearch.classList.add('is-visible');
    btnOpen.classList.add('is-visible');
    btnOpen?.setAttribute('aria-label', 'Закрыть форму поиска');
  };
  let closeSearchbar = function () {
    formSearch.classList.remove('is-visible');
    btnOpen.classList.remove('is-visible');
    btnOpen?.setAttribute('aria-label', 'Открыть форму поиска');
    input.value = '';
  };
  btnOpen.addEventListener('click', function () {
    if (btnOpen?.classList?.contains('is-visible')) {
      closeSearchbar();
    } else {
      openSearchbar();
    }
  ...
  document.addEventListener('click', function (el) {
    if (!el.target.closest('.header__form')) {
      closeSearchbar();
    }
  });
});
...
document.addEventListener("DOMContentLoaded", () => {
  const openBtnSideform = document.querySelector('.promo__btn-sideform');
  const sideform = document.querySelector('.promo__sideform');
  if (openBtnSideform) {
    openBtnSideform.addEventListener('click', e => {
      sideform.classList.add('is-visible');
      e.stopPropagation();
    });
    ...
    document.addEventListener('click', e => {
      const withinBoundaries = e.composedPath().includes('.promo__sideform');
      if (!withinBoundaries) {
        sideform.classList.remove('is-visible');
      }
    });
  }
});
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode]);

document.addEventListener('DOMContentLoaded', event => {
  const promoSlider = document.querySelector(".promo__slider");
  if (promoSlider) {
    const swiper_promoSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](promoSlider, {
      loop: true,
      slidesPerView: 1,
      effect: "fade",
      speed: 800,
  ...
  if (partnersSlider) {
    const swiper_partnersSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](partnersSlider, {
      loop: true,
      freeMode: true,
      enabled: true,
      lazy: true,
  ...
  const warehouseSlider = document.querySelector('.warehouse-section__slider');
  if (warehouseSlider) {
    const swiper_warehouseSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](warehouseSlider, {
      loop: true,
      lazy: true,
      spaceBetween: 20,
      slidesPerView: 1,
      pagination: {
        el: '.warehouse-section__pagination',
        clickable: true
      },
      breakpoints: {
        380: {
  ...
  //post-equipment
  const machineSlider = document.querySelector(".machine-slider");
  if (machineSlider) {
    const swiper_machineSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](machineSlider, {
      spaceBetween: 20,
      slidesPerView: 1,
      pagination: {
        el: '.machine-slider__pagination',
        clickable: true
      }
    });
  }
  const machineGallerySlider = document.querySelector(".machine-gallery");
  if (machineGallerySlider) {
    const swiper_machineGallerySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](machineGallerySlider, {
      spaceBetween: 20,
      slidesPerView: 1,
      navigation: {
        nextEl: ".machine-gallery__btn-next",
        prevEl: ".machine-gallery__btn-prev"
      },
      breakpoints: {
        380: {
          slidesPerView: 2
  ...
  const samplePostsSlider = document.querySelector(".sample-posts__slider");
  if (samplePostsSlider) {
    const swiper_samplePostsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](samplePostsSlider, {
      spaceBetween: 20,
      slidesPerView: 3,
      navigation: {
        nextEl: ".sample-posts__btn-next",
        prevEl: ".sample-posts__btn-prev"
      },
      breakpoints: {
        0: {
          slidesPerView: 1
...
/***/ "./src/js/components/vacanies-accordion.js":
/*!*************************************************!*\
  !*** ./src/js/components/vacanies-accordion.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('DOMContentLoaded', event => {
  const vacaniesAccordion = document.querySelector('.vacanies-accordion');
  if (vacaniesAccordion) {
    new (accordion_js__WEBPACK_IMPORTED_MODULE_0___default())(vacaniesAccordion);
  }
});
...
document.addEventListener('DOMContentLoaded', event => {
  ...
  const videoCloseBtns = document.querySelectorAll('.video-post__btn-close');
  ...
  function createIframe(videoId) {
    ...
    iframe.classList.add('video-post__iframe');
  ...
  function generateURL(videoId) {
    let query = '?rel=0&showinfo=0&autoplay=1&mute=1&start=0&enablejsapi=1';
    return 'https://www.youtube.com/embed/' + videoId + query;
  }
  const closeVideo = () => {
    videoPosts.forEach(el => {
      const videoYoutube = el.querySelector('.video-post__youtube');
      if (videoYoutube.firstChild) {
        videoYoutube.firstChild.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*");
      }
    });
  };
  if (videoPosts) {
    videoPosts.forEach(el => {
      let videoHref = el.dataset.src;
      let videoId = getVideoId(videoHref);
      let videoPoster = el.querySelector('.video-post__img img');
      // let youtubeImgSrc = 'https://i.ytimg.com/vi/' + videoId + '/maxresdefault.jpg';
      let youtubeImgSrc = 'https://i.ytimg.com/vi/' + videoId + '/sddefault.jpg';
      videoPoster.setAttribute('src', youtubeImgSrc);
      let btnOpen = el.querySelector('.btn-play');
      let videoYoutube = el.querySelector('.video-post__youtube');
      btnOpen.addEventListener('click', function () {
        closeVideo();
        ...
        const btnClose = el.querySelector('.video-post__btn-close');
        btnClose.classList.remove('visually-hidden');
        btnClose.addEventListener('click', function () {
          videoYoutube.removeChild(iframe);
          videoPoster.removeAttribute('style');
          btnOpen.removeAttribute('style');
